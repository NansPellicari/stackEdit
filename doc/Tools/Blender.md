...
| **3d viewport** | **object** | G [[shift+]Z,Y,X] | **G**rab = move selected object; if **Z,Y or X**: axis to move on, **shift** allow to select  |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzU1MDM3MDg0LDEzODUzNDM2NSwxMzUwNj
