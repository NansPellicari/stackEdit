...
| **edit** | ctrl+L | To link, for example to copy modifier on the last selection to the new one |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjkwNTYzMTIyLC05MDI0MDA2NSwtMTk3MD
EzNzg4OSwxMzI1ODgxNTcwXX0=
-->